...
namespace AdminLTE.ViewComponents
{
    public class SidebarViewComponent : ViewComponent
    {
        ...
        public IViewComponentResult Invoke(string filter)
        {
            ...
            sidebars.Add(ModuleHelper.AddModule(ModuleHelper.Module.Error, Tuple.Create(1, 0, 1)));
            ...
            */
            ...
            {
                sidebars.Add(ModuleHelper.AddHeader("USER ADMINISTRATION"));
                ...
                sidebars.Add(ModuleHelper.AddHeader("LOGS"));
